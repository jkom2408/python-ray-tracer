...
Also it is able to map these points to an in-memory canvas object, and output them as a .ppm file:
![alt text](https://user-images.githubusercontent.com/52117545/99179866-422c7a00-26d6-11eb-8255-e9caf114f27e.png "Screenshot of the PPM file")
